...
This reference of the Representational State Transfer (REST) APIs is applicable to System Center Operations Manager 1801, which supports a set of HTTP operations (methods) to create, retrieve, update, or delete access to the operational telemetry using the custom dashboard widget in the new System Center Operations Manager 1801 web console.
